  ...
  return (
    <div className="flex flex-col gap-4">
      {isAuthenticated && user && (
        <Card className="overflow-hidden">
          ...
          <div className="px-4 pb-4">
            ...
            <div className="mt-2">
              <Link to={`/@${user.username}`} className="font-semibold text-sm hover:underline">{user.display_name}</Link>
      ...
      <nav className="flex flex-col gap-1">
        ...
        {isAuthenticated && (
          <>
            <Link to={`/@${user?.username}`} className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium hover:bg-accent transition">
