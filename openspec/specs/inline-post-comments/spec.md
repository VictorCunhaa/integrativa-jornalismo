...
O painel SHALL exibir um formulário com textarea de auto-expansão e ícone de envio para usuários autenticados submeterem comentários sem sair do feed.

#### Scenario: Usuário autenticado vê o formulário
- **WHEN** o painel é aberto por um usuário autenticado
- **THEN** um textarea compacto arredondado com ícone de envio (SendHorizonal) é exibido no painel

#### Scenario: Submissão bem-sucedida
- **WHEN** o usuário preenche o textarea e aciona o envio
- **THEN** o comentário é criado, o textarea é limpo e os comentários exibidos no painel são atualizados

#### Scenario: Ícone de envio oculto com textarea vazio
- **WHEN** o textarea está vazio ou contém apenas espaços
- **THEN** o ícone de envio NÃO é exibido
